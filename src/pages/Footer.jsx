...
const Footer = () => {
    return (
        <footer className="bg-[#FBFBFF] py-24 mt-24 border-t border-indigo-100">
            <Container>
                <img src="/images/footer-bg.png" className="w-full object-center object-cover border-b" alt=""/>

                <div className="mt-8 flex items-center justify-between">
                    <p className="text-gray-500 uppercase">Copyright © 2022 AtomPay. All Rights Reserved.</p>
